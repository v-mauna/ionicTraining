...
describe('current weather', () => {
    ...
    it('fetches the current weather for the current location', async () => {
        ...
        expect(window.fetch).toHaveBeenCalledWith(
            'https://api.openweathermap.org/data/2.5/weather?lat=43.073051&lon=-89.40123&appid=0dd2e08fd19801e6177193ba30a52199'
        );
    });
...
describe('forecast', () => {
    ...
    it('fetches the forecast for the current location', async () => {
        ...
        expect(window.fetch).toHaveBeenCalledTimes(1);
        expect(window.fetch).toHaveBeenCalledWith(
            'https://api.openweathermap.org/data/2.5/forecast?lat=43.073051&lon=-89.40123&appid=0dd2e08fd19801e6177193ba30a52199'
        );
    });
...
describe('UV index', () => {
    ...
    it('fetches the UV Index for the current location', async () => {
        ...
        expect(window.fetch).toHaveBeenCalledTimes(1);
        expect(window.fetch).toHaveBeenCalledWith(
            'https://api.openweathermap.org/data/2.5/uvi?lat=43.073051&lon=-89.40123&appid=0dd2e08fd19801e6177193ba30a52199'
        );
    });
